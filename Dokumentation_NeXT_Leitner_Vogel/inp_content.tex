...
\begin{figure}[H]
	...
	\captionbelow{Stakeholder-Diagramm -->	In diesem Diagramm ist das Ergebnis der Tabelle \ref{Stakeholder-Analyse} graphisch dargestellt. Die Größe der Kreise Zeigt den Einfluss, die Länge der Linien zwischen Stakeholder und NeXt die Nähe und die Zeichen (+ --> positiv, ~ --> neutral, - --> negativ) unter dem Namen des Stakeholders dessen Nähe zum Projekt. }
\end{figure}
