...
\end{figure}
\textbf{Time-Rifts (Erklärung)}: Jeder Durchlauf hat ein Zeitlimit, dass Ziel sollte es sein durch die verschlossene Tür (grün) zu gehen.
\begin{itemize}
...
\end{figure}
Hier werden alle Vorgänge aufgelistet, die im Zeitmanagement aufgestellt wurden.
\begin{sidewaysfigure}
	\centering
	\includegraphics[width=20cm]{images/Gantt.png}
	\caption{Gantt Chart}
\end{sidewaysfigure}
In diesem Gantt-Chart sehen Sie, wie einzelne Vorgänge in zusammenhänge stehen. Eine Verzögerung bei dem Vorgang Steuerung würde eine Verzögerung bei Vorgang Time-Rift bedeuten.
...
In diesem Projekt wurde eine USE-Case-Analyse vollzogen. Als Benutzer gibt es nur den Anwender der Applikation, dessen Ziel es sein wird das Computerspiel zu spielen oder es zu beenden. Die USE-Case-Analyse und dessen Ergebnis wird als Diagramm in Abbildung \ref{USE-Case-Menu} dargestellt.
\begin{figure}[H]
	\centering
	\includegraphics[width=17.5cm,height=10cm]{images/UseCaseMenu.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=17.5cm,height=10cm]{images/UseCaseSpielen.png}
